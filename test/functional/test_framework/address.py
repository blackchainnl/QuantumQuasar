...
"""Encode and decode Blackcoin addresses.
...
ADDRESS_BCRT1_UNSPENDABLE = 'blrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqdjqgr2'
ADDRESS_BCRT1_UNSPENDABLE_DESCRIPTOR = 'addr(blrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqdjqgr2)#679zaju2'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BCRT1_P2WSH_OP_TRUE = 'blrt1qft5p2uhsdcdc3l2ua4ap5qqfg4pjaqlp250x7us7a8qqhrxrxfsqvdpfqv'
...
def create_deterministic_address_bcrt1_p2tr_op_true():
    ...
    assert_equal(address, 'blrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqs9zp339')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("blk" if main else "blrt", version, program)
