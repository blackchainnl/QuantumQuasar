...
class DescriptorTest(BitcoinTestFramework):
    ...
    def test_desc(self, desc, isrange, issolvable, hasprivatekeys):
        # Blackcoin regtest uses main xpub/xprv prefixes. Convert
        # inherited Bitcoin regtest tpub/tprv fixtures without changing key
        # material or derivation paths.
        desc = xkeys_to_main_prefix(desc)
