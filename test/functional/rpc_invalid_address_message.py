...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        # Valid Bech32
        self.check_valid(key_to_p2wpkh("0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798"))
        self.check_valid(key_to_p2wpkh("0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798").upper())
        self.check_valid(ADDRESS_BCRT1_UNSPENDABLE)
    ...
    def test_getaddressinfo(self):
        ...
        assert_raises_rpc_error(-5, GENERIC_ADDRESS_ERROR, node.getaddressinfo, BECH32_INVALID_SIZE)
        assert_raises_rpc_error(-5, GENERIC_ADDRESS_ERROR, node.getaddressinfo, BECH32_INVALID_PREFIX)
        assert_raises_rpc_error(-5, "Invalid or unsupported Base58-encoded address.", node.getaddressinfo, BASE58_INVALID_PREFIX)
        assert_raises_rpc_error(-5, GENERIC_ADDRESS_ERROR, node.getaddressinfo, INVALID_ADDRESS)
