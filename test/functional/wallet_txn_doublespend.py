...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Create two spends using the fork's cached regtest coins.
        ...
        # minus transaction fees. Unlike the inherited Bitcoin cache, this
        # fork's cached regtest wallet already exposes its initial 500,000 BLK
        # balance as mature; mining one more block here does not add another
        # spendable maturity credit.
        ...
        # double-spend, plus fees (which are negative). The extra chain
        # advances do not mature additional cached wallet rewards in this fork.
