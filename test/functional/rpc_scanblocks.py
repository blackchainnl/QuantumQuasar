...
from test_framework.descriptors import xkey_to_main_prefix
...
class ScanblocksTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Blackcoin regtest uses xpub/xprv extended-key prefixes, while
        # this inherited vector was written with Bitcoin regtest tpub bytes.
        parent_key = xkey_to_main_prefix("tpubD6NzVbkrYhZ4WaWSyoBvQwbpLkojyoTZPRsgXELWz3Popb3qkjcJyJUGLnL4qHHoQvao8ESaAstxYSnhyswJ76uZPStJRJCTKvosUCJZL5B")
        # send 1.0, mempool only
        ...
        # The inherited Bitcoin test used a precomputed false-positive
        # collision for Bitcoin's regtest genesis filter. Blackcoin's
        # genesis filter differs and scanblocks filters false positives by
        # default, so keep the positive raw-script coverage when representable.
