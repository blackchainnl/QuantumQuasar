    ...
    def run_test(self):
        ...
        if self.options.descriptors:
            w3.importdescriptors([{
                'desc': descsum_create_with_main_xkeys('wpkh(tprv8ZgxMBicQKsPcwuZGKp8TeWppSuLMiLe2d9PupB14QpPeQsqoj3LneJLhGHH13xESfvASyd4EFLJvLrG8b7DrLxEuV7hpF9uUc6XruKA1Wq/0h/*)'),
                'timestamp': 'now',
                'active': True
            },
            {
                'desc': descsum_create_with_main_xkeys('wpkh(tprv8ZgxMBicQKsPcwuZGKp8TeWppSuLMiLe2d9PupB14QpPeQsqoj3LneJLhGHH13xESfvASyd4EFLJvLrG8b7DrLxEuV7hpF9uUc6XruKA1Wq/1h/*)'),
                'timestamp': 'now',
                'active': True,
                'internal': True
            }])
        ...
        w3.getnewaddress(address_type="bech32" if self.options.descriptors else "legacy")
        w3.getrawchangeaddress(address_type="bech32" if self.options.descriptors else "legacy")
        ...
        with WalletUnlock(w4, "pass"):
            ...
            if self.options.descriptors:
                ...
                w4.sethdseed()
                w4.getnewaddress(address_type="bech32" if self.options.descriptors else "legacy")
                w4.getrawchangeaddress(address_type="bech32" if self.options.descriptors else "legacy")
