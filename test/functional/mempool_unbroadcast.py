...
class MempoolUnbroadcastTest(BitcoinTestFramework):
    ...
    def test_broadcast(self):
        ...
        # Generate a txn using sendrawtransaction. Wallet-origin rebroadcast is
        # intentionally left to wallet/P2P coverage; this fixture is scoped to
        # mempool unbroadcast persistence and retry behavior.
