...
class MempoolPackagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # This fork disables mempool replacement, so the inherited Bitcoin RBF
        # tail should assert conflict while preserving the accepted carve-out
        # transactions already in the mempool.
        replacable_tx.vout[0].nValue -= 1000000
        assert_raises_rpc_error(-26, "txn-mempool-conflict", self.nodes[0].sendrawtransaction, replacable_tx.serialize().hex())
