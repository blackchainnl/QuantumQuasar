...
class RPCGenerateTest(BitcoinTestFramework):
    ...
    def test_generateblock(self):
        ...
        combo_addresses = node.deriveaddresses(descsum_create('combo(' + combo_key + ')'))
        ...
        assert_equal(node.getrawtransaction(txid=txid, verbose=True, blockhash=hash)["txid"], txid)
        ...
        ranged_descriptor = xkeys_to_main_prefix('pkh(tpubD6NzVbkrYhZ4XgiXtGrdW5XDAPFCL9h7we1vwNCpn8tGbBcgfVYjXyhWo4E1xkh56hjod1RhGjxbaTLV3X4FyWuejifB9jusQ46QzG87VKp/0/*)')
        ...
        child_descriptor = xkeys_to_main_prefix('pkh(tpubD6NzVbkrYhZ4XgiXtGrdW5XDAPFCL9h7we1vwNCpn8tGbBcgfVYjXyhWo4E1xkh56hjod1RhGjxbaTLV3X4FyWuejifB9jusQ46QzG87VKp/0\'/0)')
