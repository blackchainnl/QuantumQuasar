...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # amounts, and minus transaction fees. Unlike the inherited Bitcoin
        # cache, this fork's cached regtest wallet already exposes its initial
        # 500,000 BLK balance as mature; mining one more block here does not
        # add another spendable maturity credit.
        ...
        # Check node0's total balance; should be same as before the clone. The
        # extra chain advances do not mature additional cached wallet rewards
        # in this fork, and any node0 block reward was not spendable before it
        # was orphaned.
        assert_equal(self.nodes[0].getbalance(), expected)
