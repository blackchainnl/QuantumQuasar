...
class GetBlockTemplateLPTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with self.nodes[0].assert_debug_log(["ThreadRPCServer method=getblocktemplate"], timeout=3):
            thr.start()
        # Generate a transaction on the node whose longpoll is waiting. This
        # isolates getblocktemplate's mempool wakeup behavior from this fork's
        # P2P relay timing and fee-filter policy differences.
