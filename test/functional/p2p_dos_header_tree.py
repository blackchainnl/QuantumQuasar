...
class RejectLowDifficultyHeadersTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        raise SkipTest(
            "Inherited Bitcoin testnet header fixture does not connect to Quantum "
            "Quasar testnet. A faithful port needs a generated fork-native "
            "historical header fixture through the first checkpoint."
        )
