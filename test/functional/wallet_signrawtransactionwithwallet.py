...
def blackcoin_tx(rawtx):
    # This fork's v1 transaction serialization includes nTime after nVersion.
    nversion = int.from_bytes(bytes.fromhex(rawtx[:8]), "little", signed=True)
    if nversion < 2:
        return rawtx[:8] + '00000000' + rawtx[8:]
    return rawtx


RAW_TX = blackcoin_tx('020000000156b958f78e3f24e0b2f4e4db1255426b0902027cb37e3ddadb52e37c3557dddb0000000000ffffffff01c0a6b929010000001600149a2ee8c77140a053f36018ac8124a6ececc1668a00000000')
...
class SignRawTransactionWithWalletTest(BitcoinTestFramework):
    ...
    def script_verification_error_test(self):
        ...
        p2wpkh_raw_tx = blackcoin_tx("")
    ...
    def test_signing_with_csv(self):
        ...
        # Use a fork-safe fee floor; the inherited Bitcoin fixture's 0.00001
        # fee is below this fork's minimum transaction fee.
        amt = Decimal(1) + utxo["amount"] - Decimal("0.01")
    ...
    def test_signing_with_cltv(self):
        ...
        # CLTV is always active in this fork; unlike Bitcoin's inherited
        # fixture, getdeploymentinfo does not expose a separate bip65 key.

        # Create a P2WSH script with CLTV. The inherited Bitcoin fixture used
        # height 100 because Bitcoin regtest maturity puts the test above that
        # height; this fork's maturity is shorter, so use the current height.
