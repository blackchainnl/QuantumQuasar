...
# Blackcoin regtest inherits a nonzero genesis chainwork offset. The
# upstream Bitcoin literal 0x65 is already satisfied at startup here, so keep
# the same relative minchainwork window above the fork's genesis work.
REGTEST_GENESIS_CHAINWORK = 0x10001
REGTEST_MIN_CHAIN_WORK = REGTEST_GENESIS_CHAINWORK + 101
...
class MinimumChainWorkTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [[], [f"-minimumchainwork={REGTEST_MIN_CHAIN_WORK:#x}"], [f"-minimumchainwork={REGTEST_MIN_CHAIN_WORK:#x}"]]
        self.node_min_work = [0, REGTEST_MIN_CHAIN_WORK, REGTEST_MIN_CHAIN_WORK]
    ...
    def run_test(self):
        ...
        starting_chain_work = REGTEST_GENESIS_CHAINWORK
