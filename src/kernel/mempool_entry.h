...
private:
    ...
    // Dandelion++
    bool m_is_dandelion_stem{false}; //!< True if this tx is in the Dandelion stem phase
    int64_t m_dandelion_arrival_time{0}; //!< Time when this tx entered the Dandelion stem phase
