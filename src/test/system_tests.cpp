...
namespace blackcoin_boost_process = boost::process::v1;
#else
#include <boost/process.hpp>
namespace blackcoin_boost_process = boost::process;
#endif
...
#endif
        BOOST_CHECK_EXCEPTION(RunCommandParseJSON("invalid_command"), blackcoin_boost_process::process_error, [&](const blackcoin_boost_process::process_error& e) {
