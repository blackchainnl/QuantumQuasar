...
BOOST_AUTO_TEST_CASE(headers_proof_of_work)
{
    const Consensus::Params& consensus_params{Params().GetConsensus()};
    const CBlockHeader valid_pow_header{Params().GenesisBlock().GetBlockHeader()};
    BOOST_CHECK(HasValidProofOfWork({valid_pow_header}, consensus_params));

    CBlockHeader unsolved_pow_header{valid_pow_header};
    do {
        ++unsolved_pow_header.nNonce;
    } while (CheckProofOfWork(unsolved_pow_header.GetPoWHash(), unsolved_pow_header.nBits, consensus_params));

    BOOST_CHECK(!HasValidProofOfWork({unsolved_pow_header}, consensus_params));
    BOOST_CHECK(!HasValidProofOfWork({valid_pow_header, unsolved_pow_header}, consensus_params));

    CBlockHeader explicit_pos_header{unsolved_pow_header};
    explicit_pos_header.nFlags = CBlockIndex::BLOCK_PROOF_OF_STAKE;
    BOOST_CHECK(HasValidProofOfWork({explicit_pos_header}, consensus_params));
}
...
BOOST_AUTO_TEST_CASE(test_assumeutxo)
{
    ...
    BOOST_CHECK_EQUAL(out110.hash_serialized.ToString(), "2e5010fbefbf7877ff73beb12b98554fb142b61946616a284e34ff9221144e27");
    BOOST_CHECK_EQUAL(out110.nChainTx, 111U);

    const auto out110_2 = *params->AssumeutxoForBlockhash(uint256S("0xe50b8be6b543975e2f5e7b7b43f87ffe6c2bb1f7be29c8732c5a8debeb9ca5a2"));
    BOOST_CHECK_EQUAL(out110_2.hash_serialized.ToString(), "2e5010fbefbf7877ff73beb12b98554fb142b61946616a284e34ff9221144e27");
...
BOOST_AUTO_TEST_CASE(block_malleation)
{
...

    {
        ...
        // empty transactions with random version and nTime fields.
        CMutableTransaction tx1;
        BOOST_CHECK(DecodeHexTx(tx1, "01000000f70d8384000000000000", /*try_no_witness=*/true, /*try_witness=*/false));
        CMutableTransaction tx2;
        BOOST_CHECK(DecodeHexTx(tx2, "01000000bf3add08000000000000", /*try_no_witness=*/true, /*try_witness=*/false));
        CMutableTransaction tx3;
        BOOST_CHECK(DecodeHexTx(tx3, "50b6e4320001c539a47dd6d915e32d85e3520f7bc36a67509809d596c3041082b0090bf95bcce3ae55f471131c19560a5070dd05e5aed3a821c3c2b7a24b6796", /*try_no_witness=*/true, /*try_witness=*/false));
        {
