...
enum WalletFlags : uint64_t {
    ...
    //! Indicates that this wallet contains wallet-managed Quantum Quasar
    //! ML-DSA private keys. This is mandatory so older clients do not open
    //! the wallet while silently ignoring quantum migration key material.
    WALLET_FLAG_QUANTUM_KEYS = (1ULL << 36),
};
