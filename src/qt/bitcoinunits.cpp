...
{
    switch (unit) {
    case Unit::BTC: return QString("Blackcoin coins");
    case Unit::mBTC: return QString("Milli-Blackcoin coins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Blackcoin coins (blits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
