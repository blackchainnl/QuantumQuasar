...
{
    // Test that the bug https://github.com/blackcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/blackcoin-core/gui/pull/568.
    // With fListen=false in the Qt settings file and all else left as default,
    // blackcoin-qt should set both -listen and -listenonion to false and start successfully.
