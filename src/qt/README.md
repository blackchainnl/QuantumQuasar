This directory contains the source code for the Blackcoin graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- ClientModel is used by the main application window and several models like `peertablemodel`.
...
- (Deprecated) Used to process BIP21 payment URI requests. Also handles URI-based application switching.
...
9. You're all set! Start developing, building, and debugging the Blackcoin GUI
