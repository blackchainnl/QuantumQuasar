    ...
    : QWidget()
{
    ...
    QString copyrightTextBase        = QChar(0xA9)+QString(" %1-%2 ").arg(2009).arg(COPYRIGHT_YEAR) + QString("The Blackcoin - Blackcoin developers");
    QString copyrightTextBlackcoin   = QChar(0xA9)+QString(" %1-%2 ").arg(2014).arg(2018) + QString("The Blackcoin developers");
    QString copyrightTextQuantum     = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The Blackcoin developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y,copyrightTextBase);
        pixPaint.drawText(x,y+10,copyrightTextBlackcoin);
        pixPaint.drawText(x,y+20,copyrightTextQuantum);
    }
