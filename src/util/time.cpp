...
static bool Gmtime(const time_t& time_val, struct tm& out)
{
#ifdef WIN32
    return gmtime_s(&out, &time_val) == 0;
#else
    return gmtime_r(&time_val, &out) != nullptr;
#endif
}
