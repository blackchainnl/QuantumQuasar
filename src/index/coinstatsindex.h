...
private:
    ...
    void AddCreatedCoin(const COutPoint& outpoint, const Coin& coin);
    void RemoveCreatedCoin(const COutPoint& outpoint, const Coin& coin);
    void RemoveSpentCoin(const COutPoint& outpoint, const Coin& coin);
    void RestoreSpentCoin(const COutPoint& outpoint, const Coin& coin);
