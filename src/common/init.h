...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn = nullptr, LegacyMigrationPromptFn legacy_migration_prompt_fn = nullptr);
} // namespace common
