...
Tracing (USDT) support for Blackcoin on Linux using. For more information on
USDT support in Blackcoin see the [USDT documentation].
...
[Blackcoin USDT documentation] on how to list available tracepoints in your
`blackcoind` binary.

[Blackcoin USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
In a different terminal, starting Blackcoin in SigNet mode and with
re-indexing enabled.
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./src/blackcoind
```
