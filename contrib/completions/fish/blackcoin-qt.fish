...
complete --command blackcoin-qt --no-files

# Extract options
function __fish_blackcoin_qt_get_options
...
complete \
    --command blackcoin-qt \
    --arguments "(__fish_blackcoin_qt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c blackcoin-qt \
...
complete \
    --command blackcoin-qt \
    --arguments "(__fish_blackcoin_qt_get_options --nofiles)"
