...
complete --command blackcoind --no-files

# Extract options
function __fish_blackcoind_get_options
...
complete \
    --command blackcoind \
    --arguments "(__fish_blackcoind_get_options --nofiles)"
