...
# Extract options
function __fish_blackcoin_tx_get_options
...
# Extract commands
function __fish_blackcoin_tx_get_commands
...
# Add options
complete \
    --command blackcoin-tx \
    --condition "not __fish_blackcoin_seen_cmd (__fish_blackcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_blackcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command blackcoin-tx \
    --arguments "(__fish_blackcoin_tx_get_commands)" \
    --no-files
