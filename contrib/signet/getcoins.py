...
parser.add_argument('client_cli_args', nargs='*', help='Arguments to pass on to blackcoin-cli (default: -signet)')

args = parser.parse_args()

if args.client_cli_args == []:
    args.client_cli_args = ['-signet']


def client_cli(rpc_command_and_params):
    argv = [args.cmd] + args.client_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = client_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = client_cli(['getnewaddress', 'faucet', 'bech32'])
