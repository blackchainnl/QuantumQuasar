# Bootstrappable Blackcoin Builds

This directory contains the files necessary to perform bootstrappable Quantum
Quasar builds.
...
To build Blackcoin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/blackcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository used for Blackcoin release signing.
...
* _**HOSTS**_
  ...
  _(defaults to "x86\_64-linux-gnu aarch64-linux-gnu riscv64-linux-gnu
