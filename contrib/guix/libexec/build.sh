...
(
    ...
    # Setup the directory where our Blackcoin build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
        # Install built Blackcoin to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    (
        ...
        # Copy over the example blackcoin.conf file. If
        # contrib/devtools/gen-blackcoin-conf.sh has not been run before
        # building, this file will be a stub.
        cp "${DISTSRC}/share/examples/blackcoin.conf" "${DISTNAME}/"
