...
$(package)_patches=silent_optional_pkg_config_probes.patch
...
$(package)_config_env += YACC="bison"
$(package)_config_env += YFLAGS="-Wno-deprecated -Wno-other"
endef

define $(package)_preprocess_cmds
  patch -p1 -i $($(package)_patch_dir)/silent_optional_pkg_config_probes.patch && \
