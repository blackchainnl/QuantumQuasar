...
$(package)_cflags += -Wno-declaration-after-statement
endef

define $(package)_preprocess_cmds
  cp -f $(BASEDIR)/config.guess $(BASEDIR)/config.sub . && \
  sed -i.bak 's/--print-errors --variable=pkgdatadir xorg-macros/--variable=pkgdatadir xorg-macros 2>\/dev\/null/' configure && \
  rm -f configure.bak
endef
