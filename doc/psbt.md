# PSBT Howto for Blackcoin

Since Blackcoin 0.17, an RPC interface exists for Partially Signed Bitcoin
...
#### Multisig with multiple Blackcoin instances
...
Blackcoin. We assume their wallets only contain the multisig funds. In case
