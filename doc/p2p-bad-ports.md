When Blackcoin automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by Blackcoin,
...
Below is a list of "bad" ports which Blackcoin avoids when choosing a peer to
