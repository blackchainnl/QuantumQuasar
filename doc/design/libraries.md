...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *blackcoin-cli* executable |
| *libbitcoin_common*      | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_util*, but higher-level (see [Dependencies](#dependencies)). |
| *libbitcoin_consensus*   | Consensus functionality used internally by *libbitcoin_node* and *libbitcoin_wallet*. |
| *libbitcoin_kernel*      | Consensus engine and support library used for validation by *libbitcoin_node*. |
| *libbitcoinqt*           | GUI functionality used by *blackcoin-qt* and *blackcoin-gui* executables |
| *libbitcoin_ipc*         | IPC functionality used by *blackcoin-node*, *blackcoin-wallet*, *blackcoin-gui* executables to communicate when [`--enable-multiprocess`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *blackcoind* and *blackcoin-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *blackcoind* and *blackcoin-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *blackcoin-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *blackcoind* and *blackcoin-qt* executables. |

## Conventions

- Libraries are internal unless explicitly documented otherwise. Internal APIs may change without backwards-compatibility guarantees.
...
blackcoin-cli[blackcoin-cli]-->libbitcoin_cli;

blackcoind[blackcoind]-->libbitcoin_node;
blackcoind[blackcoind]-->libbitcoin_wallet;

blackcoin-qt[blackcoin-qt]-->libbitcoin_node;
blackcoin-qt[blackcoin-qt]-->libbitcoinqt;
blackcoin-qt[blackcoin-qt]-->libbitcoin_wallet;

blackcoin-wallet[blackcoin-wallet]-->libbitcoin_wallet;
blackcoin-wallet[blackcoin-wallet]-->libbitcoin_wallet_tool;
...
class blackcoin-qt,blackcoind,blackcoin-cli,blackcoin-wallet bold
```
</td></tr><tr><td>
