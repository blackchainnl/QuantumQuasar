# Support for Output Descriptors in Blackcoin

Blackcoin inherits support for Output Descriptors from the upstream v0.17
descriptor work. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Blackcoin descriptor wallet to serve as your
...
existing descriptor wallets, a convenience function `combo` is
...
All Blackcoin RPCs will include the checksum in their output. Only
