...
The data directory is the default location where the Blackcoin files are stored.
...
macOS    | `$HOME/Library/Application Support/Blackcoin/`
Windows  | `%APPDATA%\Blackcoin\` <sup>[\[1\]](#note1)</sup>
...
These subdirectories and files are no longer used by Blackcoin:
