...
Below are some notes on how to build Blackcoin for Windows.

The options known to work for building Blackcoin on Windows are:
...
Note that for WSL the Blackcoin source path MUST be somewhere in the default mount file system, for
