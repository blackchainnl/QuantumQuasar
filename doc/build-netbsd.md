...
This guide describes how to build blackcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run blackcoind or the GUI.
...
Blackcoin includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure Blackcoin. Here is an example that
