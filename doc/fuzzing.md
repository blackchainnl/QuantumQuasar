# Fuzzing Blackcoin using libFuzzer

## Quickstart guide

To quickly get started fuzzing Blackcoin using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of Blackcoin fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/bitcoin_report.pdf) includes an external overview of the status of Blackcoin fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
with certain assembly code from Blackcoin's code. See [developer notes on sanitizers](https://github.com/bitcoin/bitcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Blackcoin using afl++

## Quickstart guide

To quickly get started fuzzing Blackcoin using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Blackcoin using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Blackcoin using [Honggfuzz](https://github.com/google/honggfuzz):
...
## Fuzzing the Blackcoin P2P layer using Honggfuzz NetDriver
...
$ honggfuzz/honggfuzz --exit_upon_crash --quiet --timeout 4 -n 1 -Q \
      -E HFND_TCP_PORT=18444 -f inputs/ -- \
          src/blackcoind -regtest -discover=0 -dns=0 -dnsseed=0 -listenonion=0 \
                       -nodebuglogfile -bind=127.0.0.1:18444 -logthreadnames \
                       -debug
```

# Fuzzing Blackcoin using Eclipser (v1.x)

## Quickstart guide

To quickly get started fuzzing Blackcoin using [Eclipser v1.x](https://github.com/SoftSec-KAIST/Eclipser/tree/v1.x):
...
Blackcoin participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
